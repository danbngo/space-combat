const CONSTANTS_SPECIAL_MOVES = {
    ...
    SPECIAL_MOVES: {
        ...
        possess:      { id: 'possess',      name: 'Possess',      desc: 'Seize control of any ship within 28px — friend or foe. The target goes berserk for 2 turns: randomly attacks nearby ships using only lasers and ramming, with 2× actions.', actionCost: 1, cooldown: 4 },
        ...
        swap:            { id: 'swap',            name: 'Swap',            desc: 'Instantly swap positions with another ship within 80px.',                                                                       actionCost: 1, cooldown: 3 },
        ...
        absorb:          { id: 'absorb',          name: 'Absorb',          desc: 'Drain hull from all ships within 50px — cannot reduce targets below 1 hull.',                                                   actionCost: 1, cooldown: 3 },
